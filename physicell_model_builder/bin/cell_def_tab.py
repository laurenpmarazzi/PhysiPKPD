...
class CellDef(QWidget):
    def __init__(self):
        ...
        self.tab_widget.addTab(self.create_pkpd_data_tab(),"PKPD Data")
    ...
    def create_pkpd_data_tab(self):
        ...
        pkpd_data_tab.setLayout(glayout)
        return pkpd_data_tab
...
#            self.vbox.addLayout(hbox)
    ...
    #--------------------------------------------------------
    '''def fill_pkpd_data_tab(self):
        uep_cell_defs = self.xml_root.find(".//cell_definitions")
        idx = 0
        idx_cell_def = 0
        for cell_def in uep_cell_defs:
            uep_custom_data = uep_cell_defs.find(".//cell_definition[" + str(idx_cell_def+1) + "]//pkpd_data")  # 1-offset
        ...
        for var in uep_custom_data:
            ...
            idx_cell_def += 1
            break
        uep_pkpd_data = self.xml_root.find(".//pkpd_parameters")
    ...
    def populate_tree(self):
        ...
        if uep:
            ...
            # rwh: We only use cycle code=5 or 6 in ALL sample projs?!
                ...
                print("\n===== populate():  pkpd")
                #idx = 0
                pkpd_path = ".//cell_definition[" + str(idx) + "]//pkpd_data//"
